...
const pluginName = 'CapgoCapacitorAppsflyer';
const frameworkNames = ['AppsFlyerLib'];
const phaseName = 'Capgo dSYMs for AppsFlyerLib';
...
\t\t\t);
\t\t\toutputPaths = (
\t\t\t\t"$(ARCHIVE_PATH)/dSYMs/AppsFlyerLib.framework.dSYM",
\t\t\t\t"$(DWARF_DSYM_FOLDER_PATH)/AppsFlyerLib.framework.dSYM",
\t\t\t);
